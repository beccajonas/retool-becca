<Frame
  ...
  style={{
    ordered: [
      { "primary-surface": "rgb(3, 54, 99)" },
      { "accent-background": "rgb(255, 187, 28)" },
      { "accent-foreground": "" },
      { "secondary-surface": "" },
    ],
  }}
...
>
  ...
  <Navigation
    ...
    style={{
      ordered: [
        { pillRadius: "24px" },
        { dropdownHoverText: "rgb(255, 187, 28)" },
        { highlightBackground: "rgba(255, 187, 28, 0.2)" },
        { highlightText: "rgb(255, 187, 28)" },
        { hoverText: "rgb(255, 187, 28)" },
      ],
    }}
  >
    <Option
      id="f38ed"
      appTarget="bf80ee1e-4e50-11ef-8076-1f52bae815a6"
      disabled="true"
      hidden={false}
      iconPosition="left"
      itemType="app"
    ...
    <Option
      id="87589"
      appTarget="ae5930c4-4e50-11ef-96bc-7391f520db3c"
      disabled={false}
      hidden={false}
      iconPosition="left"
      itemType="app"
    ...
    <Option
      id="255f8"
      appTarget="b5b837b6-4e50-11ef-8076-d33ae16a9353"
      disabled="true"
      itemType="app"
      key="204af"
    />
    <Option
      id="81ba5"
      appTarget="bd0e2648-c105-11ee-88fd-5ba35d9fa184"
      disabled="true"
      itemType="app"
      key="c7a1b"
    />
    <Option
      id="75d18"
      appTarget="c5c40898-c105-11ee-a76d-13543455f1b6"
      disabled="true"
      hidden={false}
      iconPosition="left"
      itemType="app"
    ...
    <Option
      id="5687f"
      appTarget="cf690e7a-c105-11ee-b734-9ffd0063fae7"
      disabled="true"
      hidden={false}
      iconPosition="left"
      itemType="app"
    ...
    <Option
      id="af672"
      appTarget="d7e0f39c-c105-11ee-8e65-87b27c9d9893"
      disabled="true"
      hidden={false}
      iconPosition="left"
      itemType="app"
    ...
    <Option
      id="eb8b0"
      appTarget="e46abddc-c105-11ee-a612-a35d6f257e0a"
      disabled="true"
      hidden={false}
      iconPosition="left"
      itemType="app"
    ...
    <Option
      id="0d386"
      appTarget="ecb74758-c105-11ee-b734-379005c3f6fe"
      disabled="true"
      hidden={false}
      iconPosition="left"
      itemType="app"
    ...
    <Option
      id="bc5c9"
      appTarget="f4f567f6-c105-11ee-86d5-33ceaa808016"
      disabled="true"
      hidden={false}
      iconPosition="left"
      itemType="app"
    ...
    <Event
      ...
      params={{
        ordered: [
          {
            options: { ordered: [{ block: "start" }, { behavior: "smooth" }] },
          },
        ],
      }}
      pluginId="text50"
  ...
  <Include src="./src/collapsibleContainer18.rsx" />
  <Text
    id="text96"
    _disclosedFields={{ array: [] }}
    marginType="normal"
    style={{ ordered: [{ background: "rgb(3, 54, 99)" }] }}
    value="### {{product.value}} 🗺️"
